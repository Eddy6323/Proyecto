                ...
                <tr>
                 ...
                 <c:forEach var="item" items="${productos}">
                    <tr>
                        ...
                        <td><a href="ProductosControlador?action=delete&id=${item.id}"onclick="return(confirm('Esta Seguro de eliminar el Producto con id= ${item.id}'))"><i class="fa-solid fa-trash"></i></a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
