...
<html lang="es">
    ...
    <body>
        <jsp:include page="META-INF/menu.jsp">
            <jsp:param name="opcion" value="reportecompras"/>
        </jsp:include>        
        <div class="container" >
            <h1>Reporte Compra</h1>
            <br>
            <form action="ReporteCompraControlador" method="post" >
            ...
            <div class="form-group col-md-6 mb-3">
                    ...
                    <select name="product" class="form-label" required="">
                        ...
                        <c:forEach var="item" items="${lista_compras}">                        
                            <option value="${item.producto}" style="background-color: #3d96f1"
                                    <c:if test="${reporte.producto == item.producto}">
                                        selected
