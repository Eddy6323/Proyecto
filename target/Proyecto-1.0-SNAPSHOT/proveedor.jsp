                ...
                <tr>
                 ...
                 <c:forEach var="item" items="${proveedor}">
                    <tr>
                        ...
                        <td><a href="ProveedorControlador?action=delete&id=${item.id}"onclick="return(confirm('Esta Seguro de eliminar el Proveedor con id= ${item.id}'))"><i class="fa-solid fa-trash"></i></a></td>
                    </tr>
                </c:forEach>
            </table>
        </div>
